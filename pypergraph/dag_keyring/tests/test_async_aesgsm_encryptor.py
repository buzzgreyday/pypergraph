import pytest
import secrets
from pypergraph.dag_keyring.encryptor import AsyncAesGcmEncryptor, SecurityException  # Adjust import based on your file structure
...
@pytest.mark.asyncio
async def test_hmac_integrity_check():
...
@pytest.mark.asyncio
async def test_vault_structure_validation():
...
@pytest.mark.asyncio
async def test_corrupt_vault_data():
...
@pytest.mark.asyncio
async def test_multiple_encryptions_different_nonces():
