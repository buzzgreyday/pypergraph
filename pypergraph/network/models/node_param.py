...
class UpdateNodeParameters(BaseModel):
    source: str
    delegated_stake_reward_parameters: DelegatedStakeRewardParameters = Field(alias="delegatedStakeRewardParameters")
    nodeMetadataParameters: NodeMetadataParameters = Field(alias="nodeMetadataParameters")
